...
<html lang="en">
<head>
  <title>Margin | Single Post</title>
...
<body class="blog">
  ...
  <main class="main-wrapper">
              ...
              <ul class="nav__menu">
                ...
                <li class="nav__dropdown active">
                  ...
                  <ul class="nav__dropdown-menu">
                    ...
                    <li><a href="single-posts.html">Single Post</a></li>
                  </ul>
                </li>
                <li>
                  <a href="#">Purchase</a>
    ...
    <div class="content-wrapper oh">
      ...
      <!-- Page Title -->
      <section class="page-title blog-featured-img bg-color-overlay bg-color-overlay--1 text-center" style="background-image: url(img/blog/featured.jpg);">
        <div class="container">
          <div class="page-title__holder">
            <h1 class="page-title__title">Effective Marketing for Start-Ups</h1>
            <ul class="entry__meta">
              <li class="entry__meta-author">
                <a href="#" class="entry__meta-author-url">
                  <img src="img/onwer/imgpostbloh.png" class="entry__meta-author-img" alt="">
                  <span>hossein fadaee</span>
                </a>
              </li>
