      ...
      <section class="page-title text-center">
        <div class="container">
          <div class="page-title__holder">
            <img width="200px" height="200px" src="<?php echo get_template_directory_uri()?>/img/onwer/8ff366c586f10211628b737986607cb3.png" alt="">
            <h1 class="page-title__title"><?php the_author()?></h1>
            <p class="page-title__subtitle"><?php the_author_description()?></p>
          </div>
        </div>
