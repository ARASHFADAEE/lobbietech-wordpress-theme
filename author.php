      ...
      <section class="page-title text-center">
        <div class="container">
          <div class="page-title__holder">
            <img width="200px" height="200px" src="/img/onwer/8ff366c586f10211628b737986607cb3.png" alt="">
            <h1 class="page-title__title">hosseinfadaee</h1>
            <p class="page-title__subtitle">I am a passionate PHP programmer and technology enthusiast with a keen interest in website design, software development, and electronics. As a programmer, I enjoy the challenges of writing clean and efficient code that is both functional and user-friendly. I find joy in staying up to date with the latest technological advancements and experimenting with new tools and techniques.
            </p>
          </div>
        </div>
            ...
            <div class="col-lg-4">
              <article class="entry card box-shadow hover-up">
                <div class="entry__img-holder card__img-holder">
                  ...
                  <div class="entry__date">
                    <span class="entry__date-day">15</span>
                    <span class="entry__date-month">aug</span>
                  </div>
                  <div class="entry__body card__body">                    
                    <h4 class="entry__title">
                      <a href="single-post.html">Breaking One Task Down Into Bite-Size Pieces</a>
                    </h4>
                    <ul class="entry__meta">
                      <li class="entry__meta-category">
                        <i class="ui-category"></i>
            ...
            <div class="col-lg-4">
              <article class="entry card box-shadow hover-up">
                <div class="entry__img-holder card__img-holder">
                  ...
                  <div class="entry__date">
                    <span class="entry__date-day">12</span>
                    <span class="entry__date-month">aug</span>
                  </div>
                  <div class="entry__body card__body">                    
                    <h4 class="entry__title">
                      <a href="single-post.html">Get Organized - Technology is your Friend</a>
                    </h4>
                    <ul class="entry__meta">
                      <li class="entry__meta-category">
                        <i class="ui-category"></i>
            ...
            <div class="col-lg-4">
              <article class="entry card box-shadow hover-up">
                <div class="entry__img-holder card__img-holder">
                  ...
                  <div class="entry__date">
                    <span class="entry__date-day">8</span>
                    <span class="entry__date-month">aug</span>
                  </div>
                  <div class="entry__body card__body">                    
                    <h4 class="entry__title">
                      <a href="single-post.html">Be Able to Meet Short Notice Deadlines</a>
                    </h4>
                    <ul class="entry__meta">
                      <li class="entry__meta-category">
                        <i class="ui-category"></i>
            ...
            <div class="col-lg-4">
              <article class="entry card box-shadow hover-up">
                <div class="entry__img-holder card__img-holder">
                  ...
                  <div class="entry__date">
                    <span class="entry__date-day">6</span>
                    <span class="entry__date-month">aug</span>
                  </div>
                  <div class="entry__body card__body">                    
                    <h4 class="entry__title">
                      <a href="single-post.html">9 Essential Parts of a Business Plan</a>
                    </h4>
                    <ul class="entry__meta">
                      <li class="entry__meta-category">
                        <i class="ui-category"></i>
            ...
            <div class="col-lg-4">
              <article class="entry card box-shadow hover-up">
                <div class="entry__img-holder card__img-holder">
                  ...
                  <div class="entry__body card__body">                    
                    <h4 class="entry__title">
                      <a href="single-post.html">Keeping Your Ideas Organized</a>
                    </h4>
                    <ul class="entry__meta">
                      <li class="entry__meta-category">
                        <i class="ui-category"></i>
